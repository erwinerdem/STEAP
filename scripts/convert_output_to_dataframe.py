...
def make_df(directory: str) -> pd.DataFrame:
    ...
    dataframe : pd.DataFrame
        The output pandas dataframe contains information about the phenotype,
...
def pvalue_correction(
    ...
    -------
    dataframe : pd.DataFrame
        The output pandas dataframe equals the input dataframe with an additional column containing
